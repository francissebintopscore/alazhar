...
<div class="custom-container">
    <div class="header">
        <div class="row">
  	  	...
  	  	<form class="form-typical" method="post" action="<?php echo base_url();?>index.php/dashboard/patientsRecord/RecordUpdate/index/<?php echo $patientInformation[0]->id;?>">
	                ...
	                <div class="row" style="align-items:flex-end;">
	                   ...
	                   <div class="col-6">
    	                    <div class="searc-wrapper">
                                ...
                                ?>
    	                        <input class="form-control <?php echo $errorClass;?>" id="regNo" name="regNo" type="text" readonly="true" value="<?php echo $regNo; ?>" maxlength="7">
	                ...
	                <div class="row" style="align-items:flex-end;">
	                    <div class="col-4">
            		  	...
            		  	<div class="col-8">
                            ...
                            ?>
            		  	    <input class="form-control <?php echo $errorClass;?> au-remove-pointer-events au-disabled" id="regDate" name="regDate" type="text" value="<?php echo $inform['regDate']; ?>" placeholder="DD-MMM-YYYY">
                            <?php echo $errorHtml;?>
            		  	</div>
	                </div>
	            </div>
	                    ...
	                    <div class="col-6">
	                        <div class="row">
	                            ...
	                            <div class="col-8">
                                    ...
                                    ?>
	                                <input class="form-control <?php echo $errorClass;?>" id="patientName" name="patientName" type="text" value="<?php echo $inform['patientName']; ?>" maxlength="100">
                                    <?php echo $errorHtml;?>
	                            </div>
	                        </div>
            		  	</div>
	                    ...
	                    <div class="col-6">
	                        <div class="row">
	                            ...
	                            <div class="col-8">
                                    ...
                                    ?>
	                                <input class="form-control <?php echo $errorClass;?>" id="dob"  type="text" name="dob"  value="<?php echo $inform['dob']; ?>" placeholder="DD-MMM-YYYY">
                                    <?php echo $errorHtml;?>
	                            </div>
	                        </div>
            		  	</div>
            		  	<div class="col-6">
            		  	    <div class="row">
            		  	        ...
            		  	        <div class="col-8">
                                    ...
                                    ?>
            		  	            <input class="form-control <?php echo $errorClass;?>" id="age" name="age" type="text" value="<?php echo $inform['age']; ?>">
                                    <?php echo $errorHtml;?>
            		  	        </div>
            		  	    </div>
            		  	</div>
    		  	        ...
    		  	        <div class="col-6">
    		  	            <div class="row">
    		  	                ...
    		  	                <div class="col-8">
                                    ...
                                    ?>
    		  	                    <input class="form-control <?php echo $errorClass;?>" id="contactNo" name="contactNo" type="text" value="<?php echo $inform['contactNo']; ?>"  maxlength="20">
                                    <?php echo $errorHtml;?>
    		  	                </div>
    		  	            </div>
            		  	</div>
	                    ...
	                    <div class="col-6">
	                        <div class="row">
	                            ...
	                            <div class="col-8">
                                    ...
                                    ?>
	                                <input class="form-control <?php echo $errorClass;?>" id="parentName" name="parentName" type="text" value="<?php echo $inform['parentName']; ?>"  maxlength="100">
                                    <?php echo $errorHtml;?>
	                            </div>
	                        </div>
            		  	</div>
            		  	<div class="col-6">
            		  	    <div class="row">
            		  	        ...
            		  	        <div class="col-8">
                                    ...
                                    ?>
            		  	            <input class="form-control <?php echo $errorClass;?>" id="emgNo" name="emgNo" type="text" value="<?php echo $inform['emgNo']; ?>"  maxlength="20">
                                    <?php echo $errorHtml;?>
            		  	        </div>
            		  	    </div>
            		  	</div>
	                    ...
	                    <div class="col-6">
	                        <div class="row">
	                            ...
	                            <div class="col-8">
                                    ...
                                    ?>
	                                <textarea class="form-control <?php echo $errorClass;?>" rows="2" id="remarks" name="remarks"  maxlength="200"><?php echo $inform['remarks']; ?></textarea>
                                    <?php echo $errorHtml;?>
	                            </div>
	                        </div>
            		  	</div>
	                    ...
	                    <div class="col-12">
	                        <div class="row">
	                            ...
	                            <div class="col-8">
                                    ...
                                    ?>
	                                <input class="form-control <?php echo $errorClass;?>" id="ex3" name="house" type="text" value="<?php echo $inform['house']; ?>" maxlength="100">
                                    <?php echo $errorHtml;?>
	                            </div>
	                        </div>
            		  	</div>
            		  	    ...
            		  	    <div class="row">
                                ...
                                <div class="col-1"></div>
            		  	        <div class="col-8">
                                    ...
                                    ?>
            		  	            <input class="form-control <?php echo $errorClass;?>" id="place" name="place" type="text" value="<?php echo $inform['place']; ?>"  maxlength="100">
                                    <?php echo $errorHtml;?>
            		  	        </div>
            		  	    </div>
            		  	</div>
            		  	    ...
            		  	    <div class="row">
                                ...
                                <div class="col-1"></div>
            		  	        <div class="col-8">
                                    ...
                                    ?>
            		  	            <input class="form-control <?php echo $errorClass;?>" id="poffice" name="poffice" type="text" value="<?php echo $inform['poffice']; ?>" maxlength="50">
                                    <?php echo $errorHtml;?>
            		  	        </div>
            		  	    </div>
            		  	</div>
            		  	    ...
            		  	    <div class="row">
                                ...
                                <div class="col-1"></div>
            		  	        <div class="col-8">
                                    ...
                                    ?>
            		  	            <input class="form-control <?php echo $errorClass;?>" id="district" name="district" type="text" value="<?php echo $inform['district']; ?>"  maxlength="50">
                                    <?php echo $errorHtml;?>
            		  	        </div>
            		  	    </div>
            		  	</div>
            		  	    ...
            		  	    <div class="row">
                                ...
                                <div class="col-1"></div>
            		  	        <div class="col-8">
                                    ...
                                    ?>
            		  	            <input class="form-control <?php echo $errorClass;?>" id="state" name="state" type="text" value="<?php echo $inform['state']; ?>"  maxlength="50">
                                    <?php echo $errorHtml;?>
            		  	        </div>
            		  	    </div>
            		  	</div>
            		  	    ...
            		  	    <div class="row">
                                ...
                                <div class="col-1"></div>
            		  	        <div class="col-8">
                                    ...
                                    ?>
            		  	            <input class="form-control <?php echo $errorClass;?>" id="pin" name="pin" type="text" value="<?php echo $inform['pin']; ?>"  maxlength="10">
                                    <?php echo $errorHtml;?>
            		  	        </div>
            		  	    </div>
            		  	</div>
	            ...
	            <div class="col-6">
    		  	...
    		  	<div class="col-6">
    		  	    <div class="footer-sec text-right">
            			...
            			<a href="<?php echo base_url();?>index.php/dashboard/patientsRecord/Revisit/" class="btn">Close</a>
            		</div>
    		  	</div>
	        </div>
		</div>
...
<script type="text/javascript" src="<?php echo base_url();?>assets/files/bootstrap-datepicker.min.js"></script>
	...
	$(document).ready(function(){
		...
		$('#opedit').on('click',function(){
			...
			if( $(this).data('edit') ){
                ...
                $('#regDate').removeClass('au-disabled');
