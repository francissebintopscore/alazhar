	            ...
	            <div class="col-6">
	                <div class="row" style="align-items:flex-end;">
	                    <div class="col-4">
            		  	...
            		  	<div class="col-8">
            		  	    <input class="form-control" id="regDate" name="regDate" type="text" value="<?php echo $inform['regDate']; ?>">
            		  	</div>
	                </div>
	            </div>
	        </div>
	                ...
	                <div class="row">
	                    <div class="col-6">
	                        <div class="row">
	                            ...
	                            <div class="col-8">
	                                <input class="form-control" id="dob"  type="text" name="dob"  value="<?php echo $inform['dob']; ?>">
	                            </div>
	                        </div>
            		  	</div>
            		  	<div class="col-6">
