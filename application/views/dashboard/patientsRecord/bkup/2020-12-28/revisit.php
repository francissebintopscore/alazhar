...
<div class="custom-container">
    <div class="side-bar">
        <ul>
            <li><a href="http://topscoresoftwares.com/demo/alazhar/index.php/dashboard/patientsRecord/RecordCreation/">Registration</a></li>
            <li><a href="http://topscoresoftwares.com/demo/alazhar/index.php/dashboard/patientsRecord/Revisit/">Revisit</a></li>
        </ul>
    </div>
    <div class="header">
        <div class="row">
	        ...
	        <div class="row">
	            ...
	            <div class="col-5">
	                <div class="seperator-div">
                		...
                		<div class="row">
                            <div class="col-12">
                                <div class="footer-sec text-right" style="margin-top: 15px;text-align: center;">
                				  	<button type="button" id="cancelBooking" class="btn" style="margin-right: 40px;">Cancel Booking</button>
...
<script type="text/javascript">
	...
	function setSearchedData( data ){
		...
		var updatedRegLink =  $('#update-link').attr('href')+data.reg_card_number;
