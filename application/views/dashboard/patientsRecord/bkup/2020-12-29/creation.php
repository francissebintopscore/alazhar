	            ...
	            <div class="col-6">
	                <div class="row" style="align-items:flex-end;">
	                    <div class="col-4">
            		  	...
            		  	<div class="col-8">
            		  	    <input class="form-control" id="regDate" name="regDate" type="text" value="<?php echo set_value('regDate'); ?>" placeholder="DD-MMM-YYYY" disabled>
            		  	</div>
	                </div>
	            </div>
	        </div>
	                ...
	                <div class="row">
	                    <div class="col-6">
	                        <div class="row">
	                            ...
	                            <div class="col-8">
	                                <input class="form-control" id="dob"  type="text" name="dob"  value="<?php echo set_value('dob'); ?>" placeholder="DD-MMM-YYYY">
	                            </div>
	                        </div>
            		  	</div>
            		  	<div class="col-6">
