...
<div class="custom-container">
    <div class="header">
        <div class="row">
  	  	...
  	  	<form class="form-typical" method="post" action="<?php echo base_url();?>index.php/dashboard/patientsRecord/RecordUpdate/index/<?php echo $regNo;?>">
	            ...
	            <div class="col-6">
	                <div class="row" style="align-items:flex-end;">
	                    <div class="col-4">
            		  	...
            		  	<div class="col-8">
            		  	    <input class="form-control au-remove-pointer-events" id="regDate" name="regDate" type="text" value="<?php echo $inform['regDate']; ?>" placeholder="DD-MMM-YYYY">
            		  	</div>
	                </div>
	            </div>
	        </div>
	                ...
	                <div class="row">
	                    <div class="col-6">
	                        <div class="row">
	                            ...
	                            <div class="col-8">
	                                <input class="form-control" id="patientName" name="patientName" type="text" value="<?php echo $inform['patientName']; ?>" maxlength="100">
	                            </div>
	                        </div>
            		  	</div>
            		  	<div class="col-6">
	                ...
	                <div class="row">
	                    <div class="col-6">
	                        <div class="row">
	                            ...
	                            <div class="col-8">
	                                <input class="form-control" id="dob"  type="text" name="dob"  value="<?php echo $inform['dob']; ?>" placeholder="DD-MMM-YYYY">
	                            </div>
	                        </div>
            		  	</div>
            		  	<div class="col-6">
	                ...
	                <div class="row">
	                    <div class="col-12">
	                        <div class="row">
	                            ...
	                            <div class="col-10">
	                                <textarea class="form-control" rows="2" id="remarks" name="remarks"  maxlength="200"><?php echo $inform['remarks']; ?></textarea>
	                            </div>
	                        </div>
            		  	</div>
	                </div>
	                    ...
	                    <div class="col-12">
            		  	...
            		  	<div class="col-12">
            		  	    <div class="row">
                                ...
                                <div class="col-1"></div>
            		  	        <div class="col-8">
            		  	            <input class="form-control" id="place" name="place" type="text" value="<?php echo $inform['place']; ?>"  maxlength="100">
            		  	        </div>
            		  	    </div>
            		  	</div>
            		  	<div class="col-12">
