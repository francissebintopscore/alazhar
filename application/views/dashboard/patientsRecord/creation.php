...
<div class="custom-container">
    <div class="header">
  	...
  	<form class="form-typical" id="insertRecordForm" method="post" action="<?php echo base_url();?>index.php/dashboard/patientsRecord/RecordCreation/">
	                ...
	                <div class="row" style="align-items:flex-end;">
	                    <div class="col-4">
            		  	...
            		  	<div class="col-8">
                            ...
                            ?>
            		  	    <input class="form-control <?php echo $errorClass;?> au-remove-pointer-events au-disabled" id="regDate" name="regDate" type="text" value="<?php echo set_value('regDate'); ?>" placeholder="DD-MMM-YYYY">
                            <?php echo $errorHtml;?>
            		  	</div>
	                </div>
	            </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        $('#saveAndPrintssssssssssssssssssss').on('click',function(e){
            e.preventDefault();

            var formdata = false;
            if (window.FormData) {
                formdata = new FormData($('#insertRecordForm')[0]);
                // var $form = $(this);
                $.ajax({
                        url: '<?php echo base_url();?>index.php/dashboard/patientsRecord/RecordCreation/ajaxDataSubmit',
                        data: formdata,
                        type:'POST',
                        contentType: false,
                        processData: false,
                        success: function(msg){
                            console.log(msg);
                            $('#insertRecordForm')[0].reset();
                            // window.location.assign('http://localhost/sebin/php/codeigniter/alazhar/index.php/dashboard/patientsRecord/Printing/index/3/2100145');
                        }
                });
            }
        })
