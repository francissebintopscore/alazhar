        ...
        <div class="row">
            <div class="col-md-12">
                <div class="text-right" style="margin:15px 0;">
                    ...
                    <input style="width: 200px;" id="date_filter" type="text" name="datetimes"/>
                    <input id="date_filter_value" type="hidden"/>
                </div>
...
<script type="text/javascript">
	...
	$(document).ready(function(){
        ...
        $('input[name="datetimes"]').on('change',function(){
            ...
            $.ajax({
                url:"<?php echo base_url();?>index.php/dashboard/patientsRecord/Report/testData2",
                type:"POST",
                data:{
